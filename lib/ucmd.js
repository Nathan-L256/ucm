...
const ucmdAutopilot = require("./ucmd-autopilot.js");
...
const {
  ...
  runObserver, parseObserverOutput, promoteProposal, runResearch, analyzeProject,
...
async function startDaemon(foreground, devMode) {
  ...
  ucmdServer.setDeps({
    ...
    handlers: () => ({
      ...
      handleAnalyzeProject, handleResearchProject,
      performCleanup,
      handleAutopilotStart: ucmdAutopilot.handleAutopilotStart,
      handleAutopilotPause: ucmdAutopilot.handleAutopilotPause,
      handleAutopilotResume: ucmdAutopilot.handleAutopilotResume,
      handleAutopilotStop: ucmdAutopilot.handleAutopilotStop,
      handleAutopilotStatus: ucmdAutopilot.handleAutopilotStatus,
      handleAutopilotSession: ucmdAutopilot.handleAutopilotSession,
      handleAutopilotApproveItem: ucmdAutopilot.handleAutopilotApproveItem,
      handleAutopilotRejectItem: ucmdAutopilot.handleAutopilotRejectItem,
      handleAutopilotFeedbackItem: ucmdAutopilot.handleAutopilotFeedbackItem,
      handleAutopilotReleases: ucmdAutopilot.handleAutopilotReleases,
      handleAutopilotDirectiveAdd: ucmdAutopilot.handleAutopilotDirectiveAdd,
      handleAutopilotDirectiveEdit: ucmdAutopilot.handleAutopilotDirectiveEdit,
      handleAutopilotDirectiveDelete: ucmdAutopilot.handleAutopilotDirectiveDelete,
      handleAutopilotDirectiveList: ucmdAutopilot.handleAutopilotDirectiveList,
    }),
    gracefulShutdown,
  });
  ...
  // recover autopilot sessions from previous daemon crash
  await ucmdAutopilot.recoverSessions();
